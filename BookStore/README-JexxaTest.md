...
domain event, or to all. The method `subscribe` is provided by [`DomainEventPublisher`]
(src/main/java/io/jexxa/tutorials/bookstore/domain/DomainEventPublisher.java) which is part
of our domain.
