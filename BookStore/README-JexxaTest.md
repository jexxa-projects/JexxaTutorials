...
As mentioned in the beginning, the recommended approach is to write unit-tests especially for your aggregates.

An example of unit-tests for our aggregate `Book` can be found [here](src/test/java/io/jexxa/tutorials/bookstore/domain/book/BookTest.java).
