package io.jexxa.tutorials.bookstorecn.architecture;
...
class ArchitectureTest {
    ...
    {
        portsAndAdapters(BookStoreCN.class)
                ...
                .addDrivingAdapterPackage("eventstream")
    ...
    {
        patternLanguage(BookStoreCN.class).validate();
    }

    @Test
    void validateAggregateRules()
    {
        aggregateRules(BookStoreCN.class).validate();
    }
}